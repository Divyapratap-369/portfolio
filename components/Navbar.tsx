...
function handleClick(e:any){
    ...
    px-4"
      >
        <div
          className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center
        justify-between"
        >
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            <a href="./assets/ATS_RESUME.pdf" target="_blank">
              <motion.button
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 0.8 }}
                className="px-4 py-2 rounded-md text-textGreen
                text-[15px] border border-textGreen hover:bg-hoverColor duration-300"
              >
                Resume
              </motion.button>
            </a>
          ...
          {showMenu && (
            ...
            >
              <motion.div
                ...
                scrollbarHide bg-[#112240] flex flex-col items-center px-4 py-10 relative"
              >
                <MdOutlineClose
                ...
                <div className="flex flex-col items-center gap-7">
                  ...
                  <a href="/public/assets/ATS_RESUME.pdf" target="_blank">
                    <motion.button
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                  ...
                  <div className="flex flex-row gap-6 text text-3xl mt-6 items-center justify-center">
                    <motion.div
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      transition={{ delay: 0.7, ease: "easeIn" }}
                    >
                      <a href="https://github.com/Divyapratap-369"
                        target="_blank">
                        <span
                          className='text-xl
                ...
                hover:-translate-y-1 transition-all duration-300"'
                    ...
                    >
                      <a
                        href="https://github.com/Divyapratap-369"
                        target="_blank"
                      >
                        <span
                          className='text-xl 
                ...
                <motion.a
                  ...
                  href="mailto:shivarajput1506@gmail.com"
                >
                  <p
                    className="text-sm w-96 tracking-widest mt-10 text-center text-textDark
        font-thin"
                  >
                    shivarajput1506@gmail.com
                  </p>
                </motion.a>
              </motion.div>
            </div>
